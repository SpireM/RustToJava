...
public class Interpreter {
    ...
    public void old() throws java.io.IOException{

        //fn main(){ let mut i; i  = 02; let mut a; if i < 3 {a = i+5;} println!(a);}
        ...
        RustToByteCode rustToByteCode = new RustToByteCode();
        walker.walk(rustToByteCode, tree);

        File byteCode = new File(rustToByteCode.nameOfProgram + ".class");
        byteCode.delete();
        byteCode.createNewFile();
        OutputStream outputStream = new FileOutputStream(byteCode);
        outputStream.write(rustToByteCode.classWriter.toByteArray());
        outputStream.close();
